 ...
 * @author wu
 */
public class InputPadFragmentKeyBoard extends Fragment implements OnClickListener, OnLongClickListener {
	...
	public static InputPadFragmentKeyBoard newInstance(int type) {
		InputPadFragmentKeyBoard fragment = new InputPadFragmentKeyBoard();
